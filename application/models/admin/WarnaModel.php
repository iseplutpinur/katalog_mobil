...
{
  private $foto_path = './files/warna/';
  private $cache_name = 'warna';
  ...
  {
    $return = $this->db->select('foto')->from('ktm_warna')->where('id', $id)->get()->row_array();
    ...
    if ($return != null) {
      ...
      // save database
      $this->db->where('id', $id);
      $res_data = $this->db->update('ktm_warna', $data);
  ...
  public function delete($id)
  {
    ...
    if ($return != null) {
      ...
      // from database foto
      $res_data = $this->db->delete('ktm_warna', ['id' => $id]);
