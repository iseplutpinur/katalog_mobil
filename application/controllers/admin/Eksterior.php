...
class Eksterior extends CI_Controller
{
  public function index()
  {
    $data['title_page'] = "List Eksterior";
    ...
    $data['nav_select'] = 'nav-eksterior';
    $data['javascript'] = "admin/eksterior/list";
    $this->load->view('admin/sitemain/header', $data);
    $this->load->view('admin/eksterior/list', $data);
  ...
  function __construct()
  {
    parent::__construct();
    is_logged_in();
    $this->load->model("admin/EksteriorModel", 'model');
  }
}
